...
- Generator output-schema bugs: add a `makeSchemaStrict` walker assertion (see the relevant app test directory). BP-016 requires this guard for any schema that's reachable from a generator output.
