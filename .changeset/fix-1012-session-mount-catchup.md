...
The list carries the 100 most recent entries, newest first. A conversation that starts more background work than that keeps showing the newest — the oldest finished work falls off the end, and there is no pagination control to reach past it.
