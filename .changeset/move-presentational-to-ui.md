...
Move presentational components out of `@flow-state-dev/react` (the style-system-free logic layer) into the `@flow-state-dev/ui` registry, and make audit results render out of the box (FIX-847).
