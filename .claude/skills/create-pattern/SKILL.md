...
Also read:
- `docs/contributing/best-practices.md` (universal rules + index) and `docs/contributing/best-practices/blocks.md` — especially BP-011 (no block.run in handlers), BP-012 (use .tap for state-only), BP-014 (never return input)
