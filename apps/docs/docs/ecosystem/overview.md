...
The Core section covers the irreducible runtime: blocks, flows, sequencers, resources, items, engine, client, testing, plus the CLI and DevTool. Everything in this section is built on top of that runtime, but isn't part of it. You can ship a flow without any of these. You'll usually want some of them.
...
The CLI and DevTool live in Core under Dev tools, next to the engine. They are how you run and inspect a flow from the terminal.
