...
- **State that evolves** — Memory isn't a conversation transcript. State evolves through typed operations, resources accumulate knowledge, and projections feed exactly what the model needs back into context every turn.
