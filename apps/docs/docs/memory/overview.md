...
- [The built-in worker](../workforce/built-in-worker#giving-workers-memory) — the recipe for attaching memory to a roster of workers, including giving each worker its own.
