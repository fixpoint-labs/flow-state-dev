...
import requestTriage from "./flows/workers/request-triage";

export const kinds = {
  "request-triage": requestTriage,
...
Anything else in those folders is skipped: a README, a fixture, a note beside the code.
