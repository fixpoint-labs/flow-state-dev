...
- **`kind`** — The flow identifier. It is also this flow's address, so it becomes the URL path: `/api/flows/hello-chat/actions/chat`. Clients use it to target this flow.
