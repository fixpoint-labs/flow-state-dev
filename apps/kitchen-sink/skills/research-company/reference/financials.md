...
- **Funding history (private) or financials (public).** For private: last round, lead investor, post-money. For public: revenue, gross margin, op margin, free cash flow if material.
...
- **Runway signals.** Cash position if disclosed, or qualitative read on how much time the company has at current burn.
