...
| BP-040 | Document intent when nav/sidebar links are removed but routes/plugins stay enabled |
| BP-041 | Docs code-block theming — built-in Prism themes first, single owner per invariant, WCAG AA on tokens |
