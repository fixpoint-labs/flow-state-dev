...
- `@flow-state-dev/fsdev`: a `fsdev benchmark` command that runs a benchmark definition and prints a table, markdown, or JSON scorecard, with a cost ceiling and a distinct judge model.
