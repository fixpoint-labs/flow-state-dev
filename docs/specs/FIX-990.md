...
> **§12 carries seven settled empirical claims** — four POC-run before drafting, three settled
> during review. **Four of the seven are refutations, three of them of claims this spec itself
> made**, and every correction is already folded into the framing below. One of the four has
...
4. **Claims stay scoped to what was measured.** Several claims here have been narrowed or
   withdrawn under scrutiny, including three the spec itself made (§12). Prefer a narrower true
   statement to a broader plausible one; the epic is named for that.
