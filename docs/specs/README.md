...
A spec is authored by `fsd:create-spec`, opened as its own PR (branch `spec/<ISSUE-ID>`)
...
The Linear issue states *what* and *why*; the spec states *how*. `fsd:implement-issue`
