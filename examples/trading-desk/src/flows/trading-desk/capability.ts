...
export const tradingDesk = defineCapability({
  ...
  presets: {
    ...
    bullContributions: {
      ...
      context: {
        bullContributions: async (_input, ctx) =>
          formatStanceContributions(
            await readContributionsEntries(ctx, "p2Contributions"),
    ...
    bearContributions: {
      resources: { p2Contributions: phase2Contributions },
      context: {
        bearContributions: async (_input, ctx) =>
          formatStanceContributions(
            await readContributionsEntries(ctx, "p2Contributions"),
    ...
    phase2Debate: {
      resources: { p2Contributions: phase2Contributions },
      context: {
        phase2Debate: async (_input, ctx) =>
          formatDebate(await readContributionsEntries(ctx, "p2Contributions")),
      },
    },
