...
export const sentimentPrompt = [
  ...
  "SECONDARY = redditMentions + sentimentContext. Note: thin/absent",
  "prediction-market coverage (see below) does NOT by itself make the memo",
  "`partial` — only `source: \"unavailable\"` on a source does.",
  "",
  ...
  "  - `backdropTheme` — the primary theme the backdrop was queried for.",
  "",
