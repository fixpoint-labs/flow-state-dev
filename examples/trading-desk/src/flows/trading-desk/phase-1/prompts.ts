...
export const fundamentalsPrompt = [
  ...
  "",
  "dataQuality sources: PRIMARY = balanceSheet / incomeStatement / cashflow /",
  "fundamentals (the structured financials). SECONDARY = fundamentalsContext.",
  "",
...
export const technicalPrompt = [
  ...
  "",
  "dataQuality sources: PRIMARY = priceHistory + indicators. SECONDARY =",
  "technicalContext.",
  "",
...
export const newsPrompt = [
  ...
  "",
  "dataQuality sources: PRIMARY = news (the headline window). SECONDARY =",
  "macro + insiderTransactions.",
  "",
...
export const sentimentPrompt = [
  ...
  "",
  "dataQuality sources: PRIMARY = socialSentiment + predictionMarkets.",
  "SECONDARY = redditMentions + sentimentContext. You have TWO primaries, so",
  "apply the shared rule across both: set `unavailable` only when BOTH",
  "socialSentiment AND predictionMarkets came back `source: \"unavailable\"`;",
  "if one primary returned real data but the other is `\"unavailable\"`, set",
  "`partial`. Note: thin/absent prediction-market coverage (see below) does",
  "NOT by itself make the memo `partial` — only `source: \"unavailable\"` on a",
  "source does.",
  "",
