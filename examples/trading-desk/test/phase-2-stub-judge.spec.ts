 ...
 * round-robin loop terminates via the pattern's `maxRounds` cap (and
 * therefore via whichever pre-built instance the router selected at
 * runtime — one of 1r-fast / 1r-full / 2r-fast / 2r-full).
 */
