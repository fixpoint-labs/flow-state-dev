...
// The app hires user-owned seats, so it installs the private roster beside
// the browser roster. Holding that owner-private collection is what arms
// registration's check, which leg (f) grades.
