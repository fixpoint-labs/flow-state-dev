...
| [`workforce-poc-e/`](workforce-poc-e) | Never-merge Workforce POC lab E: write/read goals and lessons at user / org scopes, team as org+roster key, member as named `flowIsolation` gap. No Knowledge type. |
