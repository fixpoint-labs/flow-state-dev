...
| [`workforce-poc-f/`](workforce-poc-f) | Throwaway Workforce Atlas lab F: roster intake worker with a static DM; address-the-team hits that session; routing is claim / ordered-reply / fan-out on today's dispatcher + taskBoard. Never-merge proof — not a product package. |
