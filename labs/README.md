...
| [`workforce-poc-b/`](workforce-poc-b) | Throwaway Workforce L2-on-L1 POC (lab B, never-merge): reply-storm policy on today's task-board claim. Wake ≠ turn; default quiet unless addressed; one `TaskCollectionRef.claim` per post. No Channel / MessageBoard / Workforce package. |
