...
| [`workforce-poc-d/`](workforce-poc-d) | Throwaway Workforce Atlas lab D: yaml/json seats at load into today's AgentRegistry + defineFlow. Never-merge proof — not a product package. |
