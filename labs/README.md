...
| [`workforce-poc-a/`](workforce-poc-a) | Throwaway Workforce Atlas lab A: one-worker factory, `create_session` DM, group fan-out to N subscriber sessions. Never-merge proof — not a product package. |
