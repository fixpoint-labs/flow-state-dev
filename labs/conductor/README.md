...
You answer the row by name. Daily use is `fsdev conductor` — same host as `fsdev run`. Type to talk, or use a slash verb. While composing, ↑/↓ recall a prior line and ←/→ move in it:
