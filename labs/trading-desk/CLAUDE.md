...
- [`docs/contributing/best-practices.md`](../../docs/contributing/best-practices.md) — hard rules (BP-001–BP-036): universal rules + the situational index live here; per-category situational rule text lives in [`docs/contributing/best-practices/`](../../docs/contributing/best-practices/) (e.g. `generators.md`, `resources.md`)
