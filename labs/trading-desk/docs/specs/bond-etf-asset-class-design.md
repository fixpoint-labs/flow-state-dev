...
([classify-instrument.ts:234](../../src/flows/portfolio/classify-instrument.ts#L234)).
Even an explicit `assetType: etf` import hint hardcodes `assetClass: "equity"`
([classify-instrument.ts:205-209](../../src/flows/portfolio/classify-instrument.ts#L205-L209)) —
...
File: [`src/flows/portfolio/classify-instrument.ts`](../../src/flows/portfolio/classify-instrument.ts)
...
([value-holding.ts:38](../../src/flows/portfolio/value-holding.ts#L38)). Only the
