...
const macroGenerator = generator({
  ...
  inputSchema: z.object({
    ...
    futuresCurve: toolOutputSchemas.get_futures_curve,
...
export const macroAnalyst = defineAnalyst({
  ...
  tools: {
    ...
    futuresCurve: get_futures_curve,
...
const quantGenerator = generator({
  ...
  inputSchema: z.object({
    ...
    optionsChain: toolOutputSchemas.get_options_chain,
...
export const quantAnalyst = defineAnalyst({
  ...
  tools: {
    ...
    optionsChain: get_options_chain,
