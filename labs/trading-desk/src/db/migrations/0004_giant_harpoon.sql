CREATE TABLE "app"."realized_gains" (
...
--> statement-breakpoint
ALTER TABLE "app"."ledger_events" ADD COLUMN "proceeds_unknown" text;--> statement-breakpoint
ALTER TABLE "app"."realized_gains" ADD CONSTRAINT "realized_gains_account_id_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "app"."accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
