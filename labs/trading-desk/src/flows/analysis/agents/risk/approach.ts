...
export const aggressiveApproachGenerator = createApproachGenerator({
  ...
  prompt: loadPrompt("agents/risk/prompts/aggressive-approach.prompt.md").prompt,
  uses: personaUses,
});
...
export const conservativeApproachGenerator = createApproachGenerator({
  ...
  prompt: loadPrompt("agents/risk/prompts/conservative-approach.prompt.md")
    .prompt,
  uses: personaUses,
});
...
export const neutralApproachGenerator = createApproachGenerator({
  ...
  prompt: loadPrompt("agents/risk/prompts/neutral-approach.prompt.md").prompt,
  uses: personaUses,
});
...
export const riskAssessmentApproachGenerator = createApproachGenerator({
  ...
  prompt: loadPrompt("agents/risk/prompts/risk-assessment-approach.prompt.md")
    .prompt,
  uses: [
