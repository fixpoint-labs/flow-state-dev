...
export function registerChatCommand(program: Command): void {
  program
    ...
    .option("-u, --user <id>", "Run turns as this user (default: the app's resolver's user, or cli-user with no resolver)")
    .option("--org <id>", "Run turns in this organization instead of asking the app's resolver (local only)")
