...
Headless (scripting):
  fsdev conductor status [issue]  running rows print current action; a named issue also prints last tool, files, hunk, todo; a running row prints last-write age
