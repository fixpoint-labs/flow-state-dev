 ...
 * comment frames at `intervalMs` cadence. Use this when you already have
 * an SSE byte stream and need keep-alive pings. New writable streams
 * should use `createSSEStream` instead.
 */
