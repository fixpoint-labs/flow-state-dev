...
| `defineHiredRosterPrivateCollection()` | Server-side writer for a user-owned row, at `workforce/roster/~<userId>/<seatId>`. No browser read. A `workforce/roster/**` collection is refused. |
