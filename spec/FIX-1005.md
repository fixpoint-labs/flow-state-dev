...
Below-the-bar spec-PR feedback, **recorded verbatim, not folded into the design**. Both
arrived after this spec converged; both are implementation-level obligations that live
inside decisions already made (2 and 5), not direction changes.
