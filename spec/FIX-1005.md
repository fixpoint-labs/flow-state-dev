...
four arrived after this spec converged; all four are implementation-level obligations that
live inside decisions already made (2, 4 and 5), not direction changes. Notes 2 and 3 are one
...
>   settlement in Decision 4. … use storage old writers preserve or explicitly fence
>   mixed-version writes." — codex
