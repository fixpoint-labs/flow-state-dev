...
> updating on its own has now cost **eleven** defects in one section of the build plan, all of them
...
badges suggest.** The count is **eleven, every one in §7**; nothing else in this document — the
...
three successive fixes, each of which was intended to be final.** Decision 4 is what all eleven are
...
patching it, and after eleven defects that is the evidence-based move. It does not block the demo,
