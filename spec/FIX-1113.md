...
**Open question — the one thing here that is genuinely the product owner's.**
...
`finalRating`, published unchanged. The envelope only *clamps*; absence of a clamp is not
absence of a rating.
