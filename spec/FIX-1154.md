...
- **EXTEND** `apps/docs/docs/state/mutation-model.md` — the published page a developer
  ...
  asymmetry** — same verb name, and only the resource side promises the same thing every
  time — rather than leaving it at the end where a linear reader has stopped. State the
