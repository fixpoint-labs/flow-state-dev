...
**Size:** Medium — 10 production files · 16 test behaviours · 5 doc surfaces · 1 PR.
...
back down. §7 carries the reasoning for both directions.)*
...
flowchart TD
  ...
  CLI["@flow-state-dev/cli<br/>init --report (FIX-1159)"] -->|"produces"| R
...
- **FIX-1159** — now the heavier of the two directions, and it is no longer symmetric.
  ...
  - **Whoever lands second owns making the ends meet.** Concretely, for this issue landing
    second: expand the placeholder, confirm the committed skill's block equals canonical, and
    confirm the inventory lists all five by name.
