...
with no store named), and the sender **lineage** (an authorization contract requiring a value
the persisted envelope did not carry). The tell is the same in all four: a sentence that says
