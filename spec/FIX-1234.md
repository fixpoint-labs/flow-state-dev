...
**Size:** Medium — 6 production files · 14 test behaviours · 5 doc surfaces · 1 changeset · 1 PR.
...
6. **Add the changeset** (BP-022). A `.changeset/*.md` for `@flow-state-dev/orchestration`
...
- **EXTEND** `apps/docs/docs/server/background-work.md` — one short callout carrying §5's
  ...
  subsection.
- **EXTEND** `docs/architecture/detached-work.md` (**lines 203-211**) — this is the
