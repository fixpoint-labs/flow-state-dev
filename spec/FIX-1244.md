...
worked while often not working: one re-queues any task at all and reports success, and
nothing then runs the work (§7).
...
**My recommendation: narrow the shipped verb.** A stricter verb beside it tells nobody
...
**Cost of being wrong: low and visible.** Such a board stops re-queuing on upgrade and
says why. Pre-1.0: a minor version and a changeset.
