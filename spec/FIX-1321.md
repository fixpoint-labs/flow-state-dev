...
- **No hard upstream implementation blocker.** FIX-1321 merges before FIX-1322/1323. Their specs are authored independently against the selected identity seam, not cross-reviewed before individual approval. This prerequisite has no upstream blocked-by issue; downstream Linear relations may mirror the approved merge order and do not make the registry depend on dispatch or storage.
