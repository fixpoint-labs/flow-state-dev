...
- Devtool viewing (FIX-1324) is now the fourth required epic outcome by owner direction (2026-09-07), with its own spec/approval gate, outside this issue's slice. Workforce mint (FIX-1325) remains deferred. Chat removal FIX-1330 is neither a child nor blocker. Message-board routing remains outside the floor.
