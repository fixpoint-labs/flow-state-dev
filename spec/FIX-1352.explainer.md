...
## 2. After (proposed) — a room is a folder too
...
This is the shape under approval, not a shape that ships. Same shape, deliberately: a folder with a manifest inside it. One header key is required
