...
Deliberately. A worker folder and a channel folder are containers; the atlas draws
...
So the epic ships two folder-conventions and one file-convention, on the record as a
