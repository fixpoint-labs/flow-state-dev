...
## 2. After (proposed) — ratified, not aligned
...
Ratifying is what the gate is deciding; nothing here has been approved yet. Aligning skills to the sibling shape loses on four independent counts, each measured rather
