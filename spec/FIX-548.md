...
| round | what was withdrawn | where it survived |
|---|---|---|
| `scripts.start` narrowing | epic theme 6 exception (c) dropped `start` | this spec's decision 8, change table, §8, §10 — for a full round |
| the production refusal | decision 8, after the rail was measured | the flow-file description, step 3, a §12 premise, a follow-up |
| the same refusal again | decision 8 | **the generated success transcript**, which promises it to the user |
| the §12 description | — | decision 8 pointed at a §12 that did not contain it |
