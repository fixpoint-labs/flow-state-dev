...
**Verification (BP-003 evidence path) — two real runs, read.** Run `analyze` for two tickers
...
**Pass criteria — all five, on both memos:**
...
4. Read side by side, the two memos' paragraph openers differ. This is the criterion the
   ...
   than implying it.
5. Opening one of the thirteen already-stored reports renders unchanged.
