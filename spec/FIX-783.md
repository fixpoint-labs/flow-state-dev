...
**Pass criteria — 1, 3 and 4 on each new memo; 5 on the step-0 legacy report; the stance
precondition across the pair. Criterion 2, and the second half of criterion 3, were deleted
during implementation review alongside the prompt instructions they existed to check.** Each was written against one question: *could a memo that does NOT fix the
