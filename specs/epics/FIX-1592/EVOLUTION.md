...
| The notify block is a stub that names each member and stops; "a real app puts a dispatcher here". Source: `apps/kitchen-sink/workforce/channel-notify.ts` header, shipped by FIX-1476 (#2007) | **Superseded** | FIX-1590's issue: after FIX-1585, a post notifies everyone and runs no one | ER-3 · ER-4, built by FIX-1590 | The skip-the-writer rule and leg V14 are retained |
