...
FIX-1592. FIX-1459 blocks FIX-1585 and FIX-1590. It stays another thread's issue, not a child.
...
2. **This amendment merges** → FIX-1590's and FIX-1594's specs can be written.
3. **FIX-1459 lands and FIX-1585's implementation merges** → FIX-1590 is built.
4. **FIX-1590 merges** → FIX-1594 is built.
5. **All three browser checks hold** (ER-17, ER-18) and the README says the three paths
   (ER-19) → wrap.
