...
FIX-1602 moves path two's fan-out into Workforce and kitchen-sink onto it, so the closure run
grades the stock path. FIX-1598, the durable-hire goal check, gates the closure run.
...
| **FIX-1602** stock notify fan-out · required | spec (`spec/FIX-1602`) → impl PR | FIX-1590 · FIX-1594 | FIX-1590's host glue as it ships · ER-2, ER-3 unchanged | Workforce's stock fan-out; kitchen-sink thinned onto it, its test controls and kind map left in the app (ER-10) | FIX-1601 | Medium |
...
FIX-1590 blocks FIX-1594. FIX-1590 and FIX-1594 block FIX-1602. All five block FIX-1601, the
...
2. **FIX-1594 merges** → FIX-1602 is built, and kitchen-sink moves onto its stock fan-out.
