...
| **opens a seat in the rail** | Reads its name in a roster list, and that is all there is. What kind it is, which skills it can reach and which channels it sits in are on no screen in the app | Opens it and reads its kind, the skills its own folders resolved for it, the channels it is in, and the boards those channels declare |
