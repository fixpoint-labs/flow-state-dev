...
| The epic's proof rule: [FIX-1553 ER-15](../../epics/FIX-1553/BUSINESS-RULES.md#the-proof), "FIX-1556's assembled goal under `goals/`" | **Retained**, with one addition: an unwired leg is pending and fails the run | ER-15 says the epic is done when all six legs hold; it doesn't say how a leg that isn't wired yet reports | [D3](DECISIONS.md#d3), BR-16 to BR-21 | FIX-1557 and FIX-1555 wire their legs into the named slots |
