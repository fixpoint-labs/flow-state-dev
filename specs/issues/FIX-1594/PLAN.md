...
| S6 | Docs and release note | [DOCS.md](DOCS.md)'s operations, the kitchen-sink README last (ER-19). One `minor` changeset for `@flow-state-dev/workforce`: the new tool | — |
